...
#CPP
verify/ref_model/imm_gen/imm_gen_ref_model.cpp

#Verification
verify/common/rv32i_verify_pkg.sv
verify/common/riscv_inst_pkg.sv
verify/interface/id_stage_intf.sv
verify/agents/reg_file/reg_file_agent_pkg.sv
verify/agents/id_stage/id_stage_agent_pkg.sv
